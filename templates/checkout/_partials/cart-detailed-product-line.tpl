...
<div class="product-line-grid d-flex">
  <div class="product-line-grid-left col-md-2 col-xs-4">
    <span class="product-line-grid-image media-middle">
  ...
  <div class="product-line-grid-right col-md-10 col-xs-8">
    <div class="product-line-top-content">
      <div class="product-line-top">
        <a class="product-line-title" href="{$product.url}" data-id_customization="{$product.id_customization|intval}">{$product.name}</a>
    ...
    <div class="product-line-bottom">
      ...
      <div class="product-line-price col-md-6 col-xs-6">
