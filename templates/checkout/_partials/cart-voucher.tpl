      ...
      <div class="cart-voucher js-cart-voucher">
        ...
        <div id="promo-code" class="collapse{if $cart.discounts|count > 0} in{/if}">
          <div class="promo-code">
            ...
            <a class="collapse-button promo-code-button cancel-promo" role="button" data-bs-toggle="collapse" data-target="#promo-code" aria-expanded="true" aria-controls="promo-code">
