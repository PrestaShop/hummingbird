...
<div id="checkout-modal" class="modal fade" data-ps-ref="terms-modal" tabindex="-1" role="dialog" aria-label="{l s='Terms and conditions' d='Shop.Theme.Checkout'}" aria-hidden="true">
