...
{block name='page_content'}
  ...
  {if $orders}
    <table class="table table-striped table-bordered table-labeled d-none d-sm-block d-md-block">
      <thead class="thead-default">
        <tr>
          <th>{l s='Order reference' d='Shop.Theme.Checkout'}</th>
          <th>{l s='Date' d='Shop.Theme.Checkout'}</th>
          <th>{l s='Total price' d='Shop.Theme.Checkout'}</th>
          <th class="d-none d-lg-block">{l s='Payment' d='Shop.Theme.Checkout'}</th>
    ...
    <div class="orders d-none d-sm-block d-md-none">
      {foreach from=$orders item=order}
        <div class="order">
          <div class="row">
            <div class="col-xs-10">
            ...
            <div class="col-xs-2 text-xs-end">
                <div>
