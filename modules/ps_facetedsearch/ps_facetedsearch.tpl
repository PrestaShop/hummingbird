...
{if isset($listing.rendered_facets) && !empty($listing.rendered_facets)}
  ...
  <div class="ps-facetedsearch ps-facetedsearch--mobile offcanvas offcanvas-start" tabindex="-1" id="offcanvas-faceted" data-ps-ref="faceted-offcanvas" aria-labelledby="faceted-offcanvas-label">
